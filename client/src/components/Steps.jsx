...
const Steps = () => {
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-16 xl:mt-24 justify-center">
        ...
        <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
            ...
            <div>
                ...
                <p className='text-sm text-neutral-500 mt-1'>this is demo text . Will replace  <br />this is demo</p>
            </div>
        </div>
